package net.wowdev.ecommerce.customers.controller;
...
import net.wowdev.ecommerce.customers.service.CrudCustomerService;
...
public class CustomerController {
  ...
  public CustomerDTO update(
      @PathVariable final UUID id, @Valid @RequestBody final CustomerDTO customer) {
